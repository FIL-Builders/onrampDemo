...
export const axelarBridgeAbi = [
  ...
  },
  {
    ...
    inputs: [],
    name: "gateway",
    outputs: [{ name: "", internalType: "contract IAxelarGateway", type: "address" }],
    stateMutability: "view",
  },
  {
    type: "function",
...
export const dealClientAbi = [
  ...
  },
  {
    ...
    inputs: [],
    name: "bridgeContract",
    outputs: [{ name: "", internalType: "contract IBridgeContract", type: "address" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [{ name: "", internalType: "bytes", type: "bytes" }],
    name: "pieceStatus",
    outputs: [{ name: "", internalType: "enum DealClient.Status", type: "uint8" }],
    stateMutability: "view",
  },
  {
    type: "function",
    inputs: [{ name: "_bridgeContract", internalType: "address", type: "address" }],
...
export const dealClientAxlAbi = [
  ...
  {
    type: "function",
    inputs: [{ name: "providerAddrData", internalType: "bytes", type: "bytes" }],
    name: "addGasFunds",
    outputs: [],
  ...
  },
  {
    ...
    inputs: [],
    name: "gasService",
    outputs: [{ name: "", internalType: "contract IAxelarGasService", type: "address" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [{ name: "", internalType: "bytes", type: "bytes" }],
    name: "pieceStatus",
    outputs: [{ name: "", internalType: "enum DealClientAxl.Status", type: "uint8" }],
    stateMutability: "view",
  },
  {
    type: "function",
...
export const debugReceiverAbi = [
  {
    type: "event",
    anonymous: false,
    inputs: [{ name: "Commp", internalType: "bytes", type: "bytes", indexed: false }],
    name: "ReceivedAttestation",
  },
  {
    type: "function",
