...
export interface IAxelarGateway extends BaseContract {
  ...
  adminEpoch: TypedContractMethod<[], [bigint], "view">;

  adminThreshold: TypedContractMethod<[epoch: BigNumberish], [bigint], "view">;

  admins: TypedContractMethod<[epoch: BigNumberish], [string[]], "view">;
  ...
  setup: TypedContractMethod<[params: BytesLike], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "adminEpoch"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "adminThreshold"
