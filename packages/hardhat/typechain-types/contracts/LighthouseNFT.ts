...
export interface LighthouseNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface LighthouseNFT extends BaseContract {
  connect(runner?: ContractRunner | null): LighthouseNFT;
  ...
  grantAccess: TypedContractMethod<
    [tokenId: BigNumberish, accessList: AddressLike[]],
    [void],
    "nonpayable"
  >;
  ...
  isOpenToken: TypedContractMethod<[tokenId: BigNumberish], [boolean], "view">;

  mint: TypedContractMethod<[lighthouse_cid: string], [void], "nonpayable">;

  mintPrivate: TypedContractMethod<
    [lighthouse_cid: string, accessList: AddressLike[]],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "isOpenToken"
  ): TypedContractMethod<[tokenId: BigNumberish], [boolean], "view">;
  getFunction(
    nameOrSignature: "mint"
  ): TypedContractMethod<[lighthouse_cid: string], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "mintPrivate"
  ): TypedContractMethod<
    [lighthouse_cid: string, accessList: AddressLike[]],
    [void],
    "nonpayable"
